              ...
              class Arguments < SubMatchers::Base
                module Commands
                  class GeneratePrintableArguments < Support::Command
                    ...
                    #   @return [ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Arguments]
                    #
                    ...
                    ##
                    # @param arguments [ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Arguments]
                    #
