        ...
        class DelegateTo
          module Entities
            class SubMatcherCollection
              ...
              # @api private
              #
              # @return [ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::Arguments]
              #
              def arguments
              ...
              # @api private
              #
              # @return [ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::ReturnValue, nil]
              #
              def return_value
              ...
              # @api private
              #
              # @param sub_matcher [ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::Arguments]
              #
              ...
              # @api private
              #
              # @param sub_matcher [ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::ReturnValue]
              #
