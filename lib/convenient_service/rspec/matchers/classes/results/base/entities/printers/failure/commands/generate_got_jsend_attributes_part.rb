                ...
                class Failure < Printers::Base
                  module Commands
                    class GenerateGotJsendAttributesPart < Support::Command
                      ...
                      #
                      # @!attribute printer [r]
                      #   @return [ConvenientService::RSpec::Matchers::Classes::Results::Base::Entities::Printers::Failure]
                      #
                      attr_reader :printer
                      ...
                      #
                      def code_part
                        Service::Plugins::HasJSendResult.default_failure_code?(code) ? "" : "with code `#{code}`"
                      end
