        ...
        class DelegateTo
          module Entities
            class Inputs
              ...
              #
              if Dependencies.ruby.jruby? && Dependencies.ruby.engine_version <= 9.5
                ##
                # @api private
                #
                # @return [Object] Can be any type.
              ...
              # @param block [Proc]
              # @return [Proc]
              # @raise [ConvenientService::RSpec::PrimitiveMatchers::Classes::DelegateTo::Exceptions::ReturnCustomValueChainingInvalidArguments]
              #
