      ...
      describe "#recalculate" do
        ...
        context "when used with `result`" do
          it "recalculates that `result`" do
            expect(service.result.object_id).to eq(service.result.object_id)
            expect(service.result).to eq(service.result)

            expect(service.result.object_id).not_to eq(service.recalculate.result.object_id)
        ...
        context "when used with `negated_result`" do
          it "recalculates that `negated_result`" do
            expect(service.negated_result.object_id).to eq(service.negated_result.object_id)
            expect(service.negated_result).to eq(service.negated_result)

            expect(service.negated_result.object_id).not_to eq(service.recalculate.negated_result.object_id)
        ...
        context "when used with `fallback_failure_result`" do
          it "recalculates that `fallback_failure_result`" do
            expect(service.fallback_failure_result.object_id).to eq(service.fallback_failure_result.object_id)
            expect(service.fallback_failure_result).to eq(service.fallback_failure_result)

            expect(service.fallback_failure_result.object_id).not_to eq(service.recalculate.fallback_failure_result.object_id)
        ...
        context "when used with `fallback_error_result`" do
          it "recalculates that `fallback_error_result`" do
            expect(service.fallback_error_result.object_id).to eq(service.fallback_error_result.object_id)
            expect(service.fallback_error_result).to eq(service.fallback_error_result)

            expect(service.fallback_error_result.object_id).not_to eq(service.recalculate.fallback_error_result.object_id)
        ...
        context "when used with `fallback_result`" do
          it "recalculates that `fallback_result`" do
            expect(service.fallback_result.object_id).to eq(service.fallback_result.object_id)
            expect(service.fallback_result).to eq(service.fallback_result)

            expect(service.fallback_result.object_id).not_to eq(service.recalculate.fallback_result.object_id)
