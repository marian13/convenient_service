        ...
        expect(ConvenientService::Utils::Method)
          .to receive(:defined?)
            .and_wrap_original { |original, *actual_args, **actual_kwargs, &actual_block|
              expect([actual_args, actual_kwargs, actual_block]).to eq([[method_name, mod.singleton_class], {public: public, protected: protected, private: private}, nil])
      ...
      context "when `public` is NOT passed" do
        ...
        it "delegates to `ConvenientService::Utils::Method.defined?`" do
          expect(ConvenientService::Utils::Method)
            .to receive(:defined?)
              .and_wrap_original { |original, *actual_args, **actual_kwargs, &actual_block|
                expect([actual_args, actual_kwargs, actual_block]).to eq([[method_name, mod.singleton_class], {public: true, protected: protected, private: private}, nil])
      ...
      context "when `protected` is NOT passed" do
        ...
        it "delegates to `ConvenientService::Utils::Method.defined?`" do
          expect(ConvenientService::Utils::Method)
            .to receive(:defined?)
              .and_wrap_original { |original, *actual_args, **actual_kwargs, &actual_block|
                expect([actual_args, actual_kwargs, actual_block]).to eq([[method_name, mod.singleton_class], {public: public, protected: true, private: private}, nil])
      ...
      context "when `private` is NOT passed" do
        ...
        it "delegates to `ConvenientService::Utils::Method.defined?`" do
          expect(ConvenientService::Utils::Method)
            .to receive(:defined?)
              .and_wrap_original { |original, *actual_args, **actual_kwargs, &actual_block|
                expect([actual_args, actual_kwargs, actual_block]).to eq([[method_name, mod.singleton_class], {public: public, protected: protected, private: false}, nil])
