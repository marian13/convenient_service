...
RSpec.describe ConvenientService::Dependencies::Queries::Gems::Logger, type: :standard do
  example_group "class methods" do
    describe "version" do
      it "returns version" do
        expect(described_class.version).to eq(ConvenientService::Dependencies::Queries::Version.new(Logger::VERSION))
      end
    end
