...
#
#   - https://github.com/marian13/ruby-middleware/blob/v0.4.2/spec/middleware/runner_spec.rb
#
# rubocop:disable all
RSpec.describe ConvenientService::Dependencies::Extractions::RubyMiddleware::Middleware::Runner do
