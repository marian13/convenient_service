...
RSpec.describe ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatcherCollection, type: :standard do
  include ConvenientService::RSpec::Helpers::IgnoringException

  let(:sub_matcher_collection) { described_class.new(matcher: matcher) }
  let(:matcher) { ConvenientService::RSpec::Matchers::Classes::DelegateTo.new(object, method, block_expectation) }
  ...
  let(:without_arguments_sub_matcher) { ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::WithoutArguments.new(matcher: matcher) }
  let(:with_any_arguments_sub_matcher) { ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::WithAnyArguments.new(matcher: matcher) }
  let(:with_concrete_arguments_sub_matcher) { ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::WithConcreteArguments.new(matcher: matcher) }

  let(:return_its_value_sub_matcher) { ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::ReturnDelegationValue.new(matcher: matcher) }
  let(:return_custom_value_sub_matcher) { ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::ReturnCustomValue.new(matcher: matcher) }
    ...
    describe "#arguments" do
      context "when `arguments` sub_matcher is NOT set" do
        ...
        it "defaults to `with_any_arguments`" do
          expect(sub_matcher_collection.arguments).to be_instance_of(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::WithAnyArguments)
        end
      end
