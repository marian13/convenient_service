...
RSpec.describe ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher do
  ...
  example_group "instance methods" do
    ...
    describe "#with_arguments" do
      it "sets `ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::SubMatchers::WithConcreteArguments` instance as argument chaining" do
        matcher.with_arguments

        expect(matcher.chainings.arguments).to be_instance_of(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::SubMatchers::WithConcreteArguments)
      end
    ...
    describe "#with_any_arguments" do
      it "sets `ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::SubMatchers::WithAnyArguments` instance as argument chaining" do
        matcher.with_any_arguments

        expect(matcher.chainings.arguments).to be_instance_of(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::SubMatchers::WithAnyArguments)
      end
    ...
    describe "#without_arguments" do
      it "sets `ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::SubMatchers::WithoutArguments` instance as argument chaining" do
        matcher.without_arguments

        expect(matcher.chainings.arguments).to be_instance_of(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::SubMatchers::WithoutArguments)
      end
    ...
    describe "#and_return_its_value" do
      it "sets `ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::SubMatchers::ReturnItsValue` instance as argument chaining" do
        matcher.and_return_its_value

        expect(matcher.chainings.return_its_value).to be_instance_of(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::SubMatchers::ReturnItsValue)
      end
    ...
    describe "#with_calling_original" do
      it "sets `ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::Values::WithCallingOriginal` instance as call original chaining" do
        matcher.with_calling_original

        expect(matcher.chainings.call_original).to be_instance_of(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::Values::WithCallingOriginal)
      end
    ...
    describe "#without_calling_original" do
      it "sets `ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::Values::WithoutCallingOriginal` instance as call original chaining" do
        matcher.without_calling_original

        expect(matcher.chainings.call_original).to be_instance_of(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::Values::WithoutCallingOriginal)
      end
    ...
    describe "#delegation_value" do
      it "delegates to `ConvenientService::Utils::Object`" do
        allow(ConvenientService::Utils::Object).to receive(:memoize_including_falsy_values).with(matcher, :@delegation_value).and_call_original

        matcher.delegation_value

        expect(ConvenientService::Utils::Object).to have_received(:memoize_including_falsy_values).with(matcher, :@delegation_value)
      end
    ...
    describe "#printable_method" do
      it "delegates to `ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Commands::GeneratePrintableMethod`" do
        allow(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Commands::GeneratePrintableMethod).to receive(:call).with(object: matcher.object, method: matcher.method).and_call_original

        matcher.printable_method

        expect(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Commands::GeneratePrintableMethod).to have_received(:call).with(object: matcher.object, method: matcher.method)
      end

      it "returns `ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Commands::GeneratePrintableMethod` value" do
        expect(matcher.printable_method).to eq(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Commands::GeneratePrintableMethod.call(object: matcher.object, method: matcher.method))
      end
