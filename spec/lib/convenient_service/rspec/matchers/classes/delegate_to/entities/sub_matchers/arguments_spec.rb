...
RSpec.describe ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::Arguments, type: :standard do
  ...
  example_group "instance methods" do
    describe "#apply_stubs!" do
      it "delegates to `ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::Arguments::Commands::ApplyStubToTrackDelegations`" do
