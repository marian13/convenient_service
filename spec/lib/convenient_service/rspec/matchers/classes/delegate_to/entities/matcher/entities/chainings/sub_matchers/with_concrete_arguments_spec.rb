...
RSpec.describe ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::SubMatchers::WithConcreteArguments do
  ...
  example_group "inheritance" do
    ...
    it { is_expected.to be_descendant_of(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::SubMatchers::Arguments) }
  end
  ...
  example_group "instance methods" do
    ...
    describe "#printable_expected_arguments?" do
      let(:printable_expected_arguments) { "with `#{ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::SubMatchers::Arguments::Commands::GeneratePrintableArguments.call(arguments: matcher.expected_arguments)}`" }
