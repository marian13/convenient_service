...
RSpec.describe ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::ChainingsCollection do
  let(:chainings_collection) { described_class.new(matcher: matcher) }
  let(:matcher) { ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher.new(object, method, block_expectation) }
  ...
  let(:arguments_chaining) { ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::SubMatchers::WithAnyArguments.new(matcher: matcher) }
  let(:return_its_value_chaining) { ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::SubMatchers::ReturnItsValue.new(matcher: matcher) }

  let(:without_calling_original_chaining) { ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::Values::WithoutCallingOriginal.new(matcher: matcher) }
  let(:with_calling_original_chaining) { ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::Values::WithCallingOriginal.new(matcher: matcher) }
  ...
  example_group "instance methods" do
    ...
    describe "#call_original=" do
      ...
      context "when call original chaining is already used" do
        ...
        it "raises error `ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::ChainingsCollection::Exceptions::CallOriginalChainingIsAlreadySet`" do
          expect { chainings_collection.call_original = call_original_chaining }
            .to raise_error(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::ChainingsCollection::Exceptions::CallOriginalChainingIsAlreadySet)
    ...
    describe "#arguments=" do
      ...
      context "when arguments chaining is already used" do
        ...
        it "raises error `ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::ChainingsCollection::Exceptions::ArgumentsChainingIsAlreadySet`" do
          expect { chainings_collection.arguments = arguments_chaining }
            .to raise_error(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::ChainingsCollection::Exceptions::ArgumentsChainingIsAlreadySet)
            .with_message(exception_message)
        end
      end
    end
    ...
    describe "#return_its_value=" do
      ...
      context "when return its value chaining is already used" do
        ...
        it "raises error `ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::ChainingsCollection::Exceptions::ReturnItsValueChainingIsAlreadySet`" do
          expect { chainings_collection.return_its_value = return_its_value_chaining }
            .to raise_error(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::ChainingsCollection::Exceptions::ReturnItsValueChainingIsAlreadySet)
            .with_message(exception_message)
        end
      end
    end
