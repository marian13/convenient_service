...
RSpec.describe ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::WithConcreteArguments, type: :standard do
  ...
  let(:delegation_with_expected_arguments) do
    ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Delegation.new(
      object: object,
      method: method,
      args: args,
      kwargs: kwargs,
  ...
  example_group "inheritance" do
    ...
    it { is_expected.to be_descendant_of(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::Arguments) }
  end
  ...
  example_group "instance methods" do
    ...
    describe "#printable_expected_arguments" do
      let(:printable_expected_arguments) { "with `#{ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::Arguments::Commands::GeneratePrintableArguments.call(arguments: expected_arguments)}`" }
      ...
      it "delegates to `ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::Arguments::Commands::GeneratePrintableArguments`" do
        allow(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::Arguments::Commands::GeneratePrintableArguments).to receive(:call).with(arguments: expected_arguments).and_call_original

        sub_matcher.printable_expected_arguments

        expect(ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::Arguments::Commands::GeneratePrintableArguments).to have_received(:call).with(arguments: expected_arguments)
      end
    end
  end
end
