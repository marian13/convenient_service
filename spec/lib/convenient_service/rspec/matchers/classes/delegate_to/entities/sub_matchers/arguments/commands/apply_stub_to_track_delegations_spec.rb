...
RSpec.describe ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::SubMatchers::Arguments::Commands::ApplyStubToTrackDelegations, type: :standard do
  subject(:command_result) { described_class.call(matcher: matcher) }

  let(:matcher) { ConvenientService::RSpec::Matchers::Classes::DelegateTo.new(object, method).with_calling_original }
    ...
    describe ".call" do
      ...
      context "when block expectation delegates once" do
        ...
        context "when matcher should NOT call original" do
          let(:matcher) { ConvenientService::RSpec::Matchers::Classes::DelegateTo.new(object, method).without_calling_original }
