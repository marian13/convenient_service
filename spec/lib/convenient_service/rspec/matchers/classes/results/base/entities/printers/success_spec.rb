...
RSpec.describe ConvenientService::RSpec::Matchers::Classes::Results::Base::Entities::Printers::Success do
    ...
    describe "#got_jsend_attributes_part" do
      specify do
        expect { printer.got_jsend_attributes_part }
          .to delegate_to(ConvenientService::RSpec::Matchers::Classes::Results::Base::Entities::Printers::Success::Commands::GenerateGotJsendAttributesPart, :call)
