...
RSpec.describe ConvenientService::RSpec::Matchers::Classes::Results::Base::Entities::Validator::Commands::ValidateResultStatus, type: :standard do
    ...
    describe ".call" do
      ...
      context "when matcher has result" do
        ...
        context "when chain status can NOT be casted" do
          let(:matcher) { ConvenientService::RSpec::Matchers::Classes::Results::Base.new(statuses: [chain_status]).tap { |matcher| matcher.matches?(result) } }
          let(:chain_status) { 42 }
