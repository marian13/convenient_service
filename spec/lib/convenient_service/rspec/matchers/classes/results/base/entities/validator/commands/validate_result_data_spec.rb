...
RSpec.describe ConvenientService::RSpec::Matchers::Classes::Results::Base::Entities::Validator::Commands::ValidateResultData do
        ...
        context "when `with_data` is used" do
          ...
          context "when `data` is castable" do
            ...
            example_group "`comparing_by` chain" do
              let(:result_data) { result.class.data(value: chain_data, result: result) }
