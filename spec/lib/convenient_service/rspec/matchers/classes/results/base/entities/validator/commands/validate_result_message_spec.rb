...
RSpec.describe ConvenientService::RSpec::Matchers::Classes::Results::Base::Entities::Validator::Commands::ValidateResultMessage do
        ...
        context "when `with_message` is used" do
          ...
          context "when `message` is castable" do
            ...
            example_group "`comparing_by` chain" do
              let(:result_message) { result.class.message(value: chain_message, result: result) }
