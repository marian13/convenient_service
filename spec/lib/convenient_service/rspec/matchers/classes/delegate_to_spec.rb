...
RSpec.describe ConvenientService::RSpec::Matchers::Classes::DelegateTo, type: :standard do
  ...
  example_group "instance methods" do
    ...
    describe "#with_arguments" do
      ...
      context "when arguments `sub_matcher` is already used" do
        ...
        it "raises `ConvenientService::RSpec::Matchers::Classes::DelegateTo::ArgumentsChainingIsAlreadySet`" do
    ...
    describe "#and_return_its_value" do
      ...
      context "when return value `sub_matcher` is already used" do
        ...
        it "raises `ConvenientService::RSpec::Matchers::Classes::DelegateTo::ReturnValueChainingIsAlreadySet`" do
    ...
    describe "#with_calling_original" do
      ...
      context "when call original `sub_matcher` is already used" do
        ...
        it "raises `ConvenientService::RSpec::Matchers::Classes::DelegateTo::Entities::Matcher::Entities::ChainingsCollection::Exceptions::CallOriginalChainingIsAlreadySet`" do
