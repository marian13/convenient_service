...
RSpec.describe ConvenientService::RSpec::Matchers::Custom::DelegateTo::Entities::Matcher::Entities::Chainings::Matchers::WithArguments::Commands::ApplyStubToTrackDelegations do
    ...
    describe ".call" do
      ...
      context "when block expectation delegates once" do
        ...
        context "when matcher should NOT call original" do
          let(:matcher) { ConvenientService::RSpec::Matchers::Custom::DelegateTo::Entities::Matcher.new(object, method).without_calling_original }
