  ...
  example_group "instance methods" do
    ...
    describe "#printable_actual_arguments" do
      ...
      context "when matcher has one delegation" do
        let(:printable_arguments) { ConvenientService::RSpec::Matchers::Custom::DelegateTo::Entities::Matcher::Entities::Presenter::Commands::GeneratePrintableArguments.call(arguments: matcher.delegations.first.arguments) }
      ...
      context "when matcher has multiple delegations" do
        let(:printable_arguments) do
          matcher.delegations
            .map { |delegation| ConvenientService::RSpec::Matchers::Custom::DelegateTo::Entities::Matcher::Entities::Presenter::Commands::GeneratePrintableArguments.call(arguments: delegation.arguments) }
            .join(", ")
        end
    ...
    describe "#printable_expected_arguments" do
      ...
      context "when matcher expected arguments are set" do
        ...
        it "delegates to `ConvenientService::RSpec::Matchers::Custom::DelegateTo::Entities::Matcher::Entities::Presenter::Commands::GeneratePrintableArguments`" do
          allow(ConvenientService::RSpec::Matchers::Custom::DelegateTo::Entities::Matcher::Entities::Presenter::Commands::GeneratePrintableArguments).to receive(:call).with(arguments: arguments).and_call_original

          presenter.printable_expected_arguments

          expect(ConvenientService::RSpec::Matchers::Custom::DelegateTo::Entities::Matcher::Entities::Presenter::Commands::GeneratePrintableArguments).to have_received(:call).with(arguments: arguments)
        end

        it "returns `ConvenientService::RSpec::Matchers::Custom::DelegateTo::Entities::Matcher::Entities::Presenter::Commands::GeneratePrintableArguments` value" do
          expect(presenter.printable_expected_arguments).to eq(ConvenientService::RSpec::Matchers::Custom::DelegateTo::Entities::Matcher::Entities::Presenter::Commands::GeneratePrintableArguments.call(arguments: arguments))
        end
      end
    end
