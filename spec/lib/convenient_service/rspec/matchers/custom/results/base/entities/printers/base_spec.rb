...
RSpec.describe ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Base do
    ...
    describe "#expected_parts" do
      specify do
        expect { printer.expected_parts }
          .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Base::Commands::GenerateExpectedParts, :call)
    ...
    describe "#got_parts" do
      specify do
        expect { printer.got_parts }
          .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Base::Commands::GenerateGotParts, :call)
          .with_arguments(printer: printer)
          .and_return_its_value
      end
    end
    ...
    describe "#expected_code_part" do
      specify do
        expect { printer.expected_code_part }
          .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Base::Commands::GenerateExpectedCodePart, :call)
          .with_arguments(printer: printer)
          .and_return_its_value
      end
    end
    ...
    describe "#expected_data_part" do
      specify do
        expect { printer.expected_data_part }
          .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Base::Commands::GenerateExpectedDataPart, :call)
          .with_arguments(printer: printer)
          .and_return_its_value
      end
    end
    ...
    describe "#expected_message_part" do
      specify do
        expect { printer.expected_message_part }
          .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Base::Commands::GenerateExpectedMessagePart, :call)
          .with_arguments(printer: printer)
          .and_return_its_value
      end
    end
    ...
    describe "#expected_service_part" do
      specify do
        expect { printer.expected_service_part }
          .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Base::Commands::GenerateExpectedServicePart, :call)
          .with_arguments(printer: printer)
          .and_return_its_value
      end
    end
    ...
    describe "#expected_status_part" do
      specify do
        expect { printer.expected_status_part }
          .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Base::Commands::GenerateExpectedStatusPart, :call)
          .with_arguments(printer: printer)
          .and_return_its_value
      end
    end
    ...
    describe "#expected_step_part" do
      specify do
        expect { printer.expected_step_part }
          .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Base::Commands::GenerateExpectedStepPart, :call)
          .with_arguments(printer: printer)
          .and_return_its_value
      end
    end
    ...
    describe "#got_step_part" do
      specify do
        expect { printer.got_step_part }
          .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Base::Commands::GenerateGotStepPart, :call)
          .with_arguments(printer: printer)
          .and_return_its_value
      end
    end
    ...
    describe "#got_service_part" do
      specify do
        expect { printer.got_service_part }
          .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Base::Commands::GenerateGotServicePart, :call)
          .with_arguments(printer: printer)
          .and_return_its_value
      end
    end
