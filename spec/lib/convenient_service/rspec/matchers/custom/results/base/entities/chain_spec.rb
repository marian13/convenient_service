...
RSpec.describe ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Chain do
  example_group "instance methods" do
    ...
    describe "#comparison_method" do
      context "when comparison_method is NOT set" do
        ...
        it "returns `ConvenientService::RSpec::Matchers::Custom::Results::Base::Constants::DEFAULT_COMPARISON_METHOD`" do
          expect(chain.comparison_method).to eq(ConvenientService::RSpec::Matchers::Custom::Results::Base::Constants::DEFAULT_COMPARISON_METHOD)
        end
      end
