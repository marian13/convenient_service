...
RSpec.describe ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers do
    ...
    describe "#create" do
      context "when matcher does NOT have result" do
        ...
        specify do
          expect { described_class.create(matcher: matcher) }
            .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Null, :new)
      ...
      context "when matcher has result" do
        context "when matcher has result with success status" do
          ...
          specify do
            expect { described_class.create(matcher: matcher) }
              .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Success, :new)
              .with_arguments(matcher: matcher)
              .and_return_its_value
          end
        end
        ...
        context "when matcher has result with failure status" do
          ...
          specify do
            expect { described_class.create(matcher: matcher) }
              .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Failure, :new)
              .with_arguments(matcher: matcher)
              .and_return_its_value
          end
        end
        ...
        context "when matcher has result with error status" do
          ...
          specify do
            expect { described_class.create(matcher: matcher) }
              .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers::Error, :new)
              .with_arguments(matcher: matcher)
              .and_return_its_value
          end
        end
