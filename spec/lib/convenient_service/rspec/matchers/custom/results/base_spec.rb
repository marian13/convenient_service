...
RSpec.describe ConvenientService::RSpec::Matchers::Custom::Results::Base do
  ...
  let(:chain) { ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Chain.new.tap { |chain| chain.statuses = statuses } }
    ...
    describe "#printer" do
      specify do
        expect { matcher.printer }
          .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Printers, :create)
    ...
    describe "#validator" do
      specify do
        expect { matcher.validator }
          .to delegate_to(ConvenientService::RSpec::Matchers::Custom::Results::Base::Entities::Validator, :new)
          .with_arguments(matcher: matcher)
          .and_return_its_value
      end
