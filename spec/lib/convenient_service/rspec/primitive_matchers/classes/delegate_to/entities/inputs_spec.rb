...
RSpec.describe ConvenientService::RSpec::PrimitiveMatchers::Classes::DelegateTo::Entities::Inputs, type: :standard do
  ...
  example_group "instance methods" do
    ...
    describe "#printable_method" do
      it "delegates to `ConvenientService::RSpec::PrimitiveMatchers::Classes::DelegateTo::Commands::GeneratePrintableMethod`" do
        allow(ConvenientService::RSpec::PrimitiveMatchers::Classes::DelegateTo::Commands::GeneratePrintableMethod).to receive(:call).with(object: object, method: method).and_call_original

        inputs.printable_method

        expect(ConvenientService::RSpec::PrimitiveMatchers::Classes::DelegateTo::Commands::GeneratePrintableMethod).to have_received(:call).with(object: object, method: method)
      end

      it "returns `ConvenientService::RSpec::PrimitiveMatchers::Classes::DelegateTo::Commands::GeneratePrintableMethod` value" do
        expect(inputs.printable_method).to eq(ConvenientService::RSpec::PrimitiveMatchers::Classes::DelegateTo::Commands::GeneratePrintableMethod.call(object: object, method: method))
      end
    ...
    describe "#update_expected_return_value_block" do
      ...
      context "when NO `return_value` is passed" do
        context "when NO `block` is passsed" do
          ...
          it "raises `ConvenientService::RSpec::PrimitiveMatchers::Classes::DelegateTo::Exceptions::ReturnCustomValueChainingInvalidArguments`" do
            expect { inputs.update_expected_return_value_block }
              .to raise_error(ConvenientService::RSpec::PrimitiveMatchers::Classes::DelegateTo::Exceptions::ReturnCustomValueChainingInvalidArguments)
