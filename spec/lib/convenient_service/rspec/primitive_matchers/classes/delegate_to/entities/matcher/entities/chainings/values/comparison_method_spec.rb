...
RSpec.describe ConvenientService::RSpec::PrimitiveMatchers::Classes::DelegateTo::Entities::Matcher::Entities::Chainings::Values::ComparisonMethod do
  ...
  example_group "instance methods" do
    describe "#value" do
      it "returns matcher `comparison_method`" do
        expect(chaining.value).to eq(matcher.comparison_method)
      end
    end
  end
end
