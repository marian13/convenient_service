...
RSpec.describe ConvenientService::RSpec::PrimitiveMatchers::IncludeInOrder, type: :standard do
    ...
    describe "#include_module" do
      ...
      specify do
        expect { instance.include_in_order(keywords) }
          .to delegate_to(ConvenientService::RSpec::PrimitiveMatchers::Classes::IncludeInOrder, :new)
