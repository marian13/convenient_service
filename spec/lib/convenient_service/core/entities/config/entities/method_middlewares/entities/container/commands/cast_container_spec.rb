...
RSpec.describe ConvenientService::Core::Entities::Config::Entities::MethodMiddlewares::Entities::Container::Commands::CastContainer, type: :standard do
  example_group "class methods" do
    describe ".call" do
          ...
          context "when value by `:scope` key is `:instance`" do
            ...
            context "when value by `:klass` key is any class" do
              ...
              it "returns other casted to container" do
                expect(casted).to eq(ConvenientService::Core::Entities::Config::Entities::MethodMiddlewares::Entities::Container.new(klass: klass))
              end
            end
          end
      ...
      context "when `other` is container" do
        let(:other) { ConvenientService::Core::Entities::Config::Entities::MethodMiddlewares::Entities::Container.cast({scope: scope, klass: klass}) }
