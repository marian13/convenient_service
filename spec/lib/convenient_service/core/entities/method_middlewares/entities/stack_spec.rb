...
RSpec.describe ConvenientService::Core::Entities::MethodMiddlewares::Entities::Stack do
  ...
  let(:middleware) do
    Class.new(ConvenientService::Core::Entities::MethodMiddlewares::Entities::Middleware) do
      def next(...)
        chain.next(...)
      end
    end
