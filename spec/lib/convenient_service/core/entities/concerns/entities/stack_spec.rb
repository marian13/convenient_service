...
RSpec.describe ConvenientService::Core::Entities::Concerns::Entities::Stack do
  ...
  let(:middleware) { ConvenientService::Core::Entities::Concerns::Entities::Middleware.cast(concern) }
  let(:other_middleware) { ConvenientService::Core::Entities::Concerns::Entities::Middleware.cast(other_concern) }
