...
RSpec.describe ConvenientService::Support::Middleware::StackBuilder::Entities::Builders::Custom, type: :standard do
  ...
  example_group "instance methods" do
    ...
    example_group "abstract methods" do
      ...
      #
      specify { expect { stack_builder.call_with_original }.to raise_error(ConvenientService::Support::AbstractMethod::Exceptions::AbstractMethodNotOverridden) }
      specify { expect { stack_builder.call }.to raise_error(ConvenientService::Support::AbstractMethod::Exceptions::AbstractMethodNotOverridden) }
    end
    ...
    describe "#insert" do
      ...
      context "when `index_or_middleware` is middleware" do
        context "when that middleware is NOT found in stack" do
          ...
          it "raises `ConvenientService::Support::Middleware::StackBuilder::Entities::Builders::Naive::Exceptions::MissingMiddleware`" do
            expect { stack_builder.insert(middleware, other_middleware) }
              .to raise_error(ConvenientService::Support::Middleware::StackBuilder::Entities::Builders::Naive::Exceptions::MissingMiddleware)
          ...
          specify do
            ...
            expect { stack_builder.insert(middleware, other_middleware) }.to raise_error(ConvenientService::Support::Middleware::StackBuilder::Entities::Builders::Naive::Exceptions::MissingMiddleware)
          end
          # rubocop:enable RSpec/MultipleExpectations, RSpec/MessageSpies, RSpec/ExampleLength
        end
      ...
      context "when `index_or_middleware` is middleware" do
        context "when that middleware is NOT found in stack" do
          ...
          specify do
            ...
            expect { stack_builder.insert_before(middleware, other_middleware) }.to raise_error(ConvenientService::Support::Middleware::StackBuilder::Entities::Builders::Naive::Exceptions::MissingMiddleware)
          end
          # rubocop:enable RSpec/MultipleExpectations, RSpec/MessageSpies, RSpec/ExampleLength
        end
      ...
      context "when `index_or_middleware` is middleware" do
        context "when that middleware is NOT found in stack" do
          ...
          specify do
            ...
            expect { stack_builder.insert_after(middleware, other_middleware) }.to raise_error(ConvenientService::Support::Middleware::StackBuilder::Entities::Builders::Naive::Exceptions::MissingMiddleware)
          end
          # rubocop:enable RSpec/MultipleExpectations, RSpec/MessageSpies, RSpec/ExampleLength
        end
      ...
      context "when `index_or_middleware` is middleware" do
        context "when that middleware is NOT found in stack" do
          ...
          specify do
            ...
            expect { stack_builder.replace(middleware, other_middleware) }.to raise_error(ConvenientService::Support::Middleware::StackBuilder::Entities::Builders::Naive::Exceptions::MissingMiddleware)
          end
          # rubocop:enable RSpec/MultipleExpectations, RSpec/MessageSpies, RSpec/ExampleLength
        end
    ...
    describe "#delete" do
      context "when stack does NOT have middleware" do
        ...
        specify do
          ...
          expect { stack_builder.delete(middleware) }.to raise_error(ConvenientService::Support::Middleware::StackBuilder::Entities::Builders::Naive::Exceptions::MissingMiddleware)
        end
        # rubocop:enable RSpec/MultipleExpectations, RSpec/MessageSpies, RSpec/ExampleLength
      end
    ...
    describe "#remove" do
      context "when stack does NOT have middleware" do
        ...
        specify do
          ...
          expect { stack_builder.remove(middleware) }.to raise_error(ConvenientService::Support::Middleware::StackBuilder::Entities::Builders::Naive::Exceptions::MissingMiddleware)
        end
        # rubocop:enable RSpec/MultipleExpectations, RSpec/MessageSpies, RSpec/ExampleLength
      end
    ...
    describe "#dup" do
      ...
      #
      # rubocop:disable RSpec/MultipleExpectations, RSpec/MessageSpies, RSpec/ExampleLength
      it "delegates to `ConvenientService::Support::Middleware::StackBuilder::Entities::Builders::Naive.new`" do
      ...
      it "returns `ConvenientService::Support::Middleware::StackBuilder::Entities::Builders::Naive.new` value" do
