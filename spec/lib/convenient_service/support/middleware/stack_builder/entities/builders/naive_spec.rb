...
RSpec.describe ConvenientService::Support::Middleware::StackBuilder::Entities::Builders::Naive, type: :standard do
  ...
  example_group "instance methods" do
    ...
    describe "#call" do
      example_group "e2e" do
        ...
        before do
          stub_const("ConvenientService::Support::Middleware::StackBuilder::Constants::Backends::DEFAULT", ConvenientService::Support::Middleware::StackBuilder::Constants::Backends::NAIVE)
        end
