...
RSpec.describe ConvenientService::Support::Gems::Paint, type: :standard do
  example_group "class methods" do
    describe "version" do
      it "returns version" do
        expect(described_class.version).to eq(ConvenientService::Support::Version.new(Paint::VERSION))
      end
    end
