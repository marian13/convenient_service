...
RSpec.describe ConvenientService::Support::Cache::Entities::Caches::Hash, type: :standard do
  ...
  example_group "instance methods" do
    ...
    describe "#backend" do
      ...
      it "returns `ConvenientService::Support::Cache::Constants::Backends::HASH`" do
        expect(cache.backend).to eq(ConvenientService::Support::Cache::Constants::Backends::HASH)
      end
    end
