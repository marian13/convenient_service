...
RSpec.describe ConvenientService::Service::Plugins::CanHaveSteps::Entities::Step::Exceptions, type: :standard do
  ...
  specify { expect(described_class::UnsupportedKeyType).to be_descendant_of(ConvenientService::Exception) }
end
