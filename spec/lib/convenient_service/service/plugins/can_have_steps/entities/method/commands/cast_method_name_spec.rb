...
RSpec.describe ConvenientService::Service::Plugins::CanHaveSteps::Entities::Method::Commands::CastMethodName do
    ...
    describe ".call" do
      ...
      context "when `other` is symbol" do
        ...
        it "returns symbol casted to method name" do
          expect(casted).to eq(ConvenientService::Service::Plugins::CanHaveSteps::Entities::Method::Entities::Name.new(other))
        end
      end
      ...
      context "when `other` is hash" do
        ...
        context "when that hash has one key" do
          ...
          context "when value by that key is symbol" do
            ...
            it "returns proc casted to method name" do
              expect(casted).to eq(ConvenientService::Service::Plugins::CanHaveSteps::Entities::Method::Entities::Name.new(:bar))
            end
          end
          ...
          context "when value by that key is proc" do
            ...
            it "returns proc casted to method name" do
              expect(casted).to eq(ConvenientService::Service::Plugins::CanHaveSteps::Entities::Method::Entities::Name.new(:foo))
            end
          end
          ...
          context "when value by that key is raw value" do
            ...
            it "returns raw value casted to method name" do
              expect(casted).to eq(ConvenientService::Service::Plugins::CanHaveSteps::Entities::Method::Entities::Name.new(:foo))
            end
          end

          context "when value by that key is reassignemnt" do
            let(:other) { {foo: ConvenientService::Service::Plugins::CanHaveSteps::Entities::Method::Entities::Values::Reassignment.new("bar")} }
      ...
      context "when `other` is reassignemnt" do
        let(:other) { ConvenientService::Service::Plugins::CanHaveSteps::Entities::Method::Entities::Values::Reassignment.new("foo") }
      ...
      context "when `other` is method" do
        ...
        it "returns its name copy" do
          expect(casted).to eq(other.name.copy)
        end
      end
    end
  end
