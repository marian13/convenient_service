...
RSpec.describe ConvenientService::Service::Plugins::CanHaveSteps::Entities::Method::Entities::Factories::Hash::ProcValue, type: :standard do
    ...
    describe "#create_caller" do
      specify do
        expect { factory.create_caller }
          .to delegate_to(ConvenientService::Service::Plugins::CanHaveSteps::Entities::Method::Entities::Callers::Proc, :new)
