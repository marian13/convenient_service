...
RSpec.describe ConvenientService::Service::Plugins::CanHaveSteps::Entities::Method::Commands::CastMethodKey do
    ...
    describe ".call" do
      ...
      context "when `other` is symbol" do
        ...
        it "returns symbol casted to method key" do
          expect(casted).to eq(ConvenientService::Service::Plugins::CanHaveSteps::Entities::Method::Entities::Key.new(other))
        end
      end
        ...
        context "when that hash has one key" do
          ...
          context "when value by that key is symbol" do
            ...
            it "returns proc casted to method key" do
              expect(casted).to eq(ConvenientService::Service::Plugins::CanHaveSteps::Entities::Method::Entities::Key.new(:foo))
            end
          end
