...
RSpec.describe ConvenientService::Service::Plugins::CanHaveStepAwareEnumerables::Entities::StepAwareEnumerables::Hash, type: :standard do
  include ConvenientService::RSpec::Matchers::DelegateTo

  let(:step_aware_hash) { described_class.new(object: object, organizer: organizer, propagated_result: propagated_result) }
  ...
  example_group "instance methods" do
    ...
    describe "#default_evaluate_by" do
      it "returns `:to_h`" do
        expect(step_aware_hash.default_evaluate_by).to eq(:to_h)
      end
    end
  end
end
