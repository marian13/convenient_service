...
RSpec.describe ConvenientService::Service::Plugins::HasResultShortSyntax::Error::Middleware do
  ...
  example_group "instance methods" do
    describe "#call" do
      ...
      specify do
        expect { method_value }
          .to delegate_to(ConvenientService::Service::Plugins::HasResultShortSyntax::Error::Commands::AssertEitherArgsOrKwargsArePassed, :call)
          .with_arguments(args: [], kwargs: {})
      end

      specify do
        expect { method_value }
          .to delegate_to(ConvenientService::Service::Plugins::HasResultShortSyntax::Error::Commands::AssertArgsCountLowerThanThree, :call)
          .with_arguments(args: [])
      end
