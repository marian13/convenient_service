...
RSpec.describe ConvenientService::Service::Plugins::HasResult::Entities::Result::Plugins::CanHaveParentResult::Concern do
    ...
    describe "#parents" do
      ...
      example_group "`limit` option" do
        ...
        context "when `limit` is NOT passed" do
          ...
          before do
            stub_const("ConvenientService::Service::Plugins::HasResult::Entities::Result::Plugins::CanHaveParentResult::Constants::PARENTS_LIMIT", 1)
          end

          it "defaults to `ConvenientService::Service::Plugins::HasResult::Entities::Result::Plugins::CanHaveParentResult::Constants::PARENTS_LIMIT`" do
            expect(result.parents).to eq(parents)
          end
        end
