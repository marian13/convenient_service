...
RSpec.describe ConvenientService::Service::Plugins::HasResult::Entities::Result::Plugins::CanBeTried::ToKwargs::Middleware do
  ...
  example_group "instance methods" do
    describe "#call" do
      ...
      it "merges `try_result` to kwargs" do
        expect(method_value[:try_result]).to eq(result.try_result?)
      end
    end
  end
end
