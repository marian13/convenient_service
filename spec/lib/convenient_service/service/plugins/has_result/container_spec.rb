...
RSpec.describe ConvenientService::Service::Plugins::HasResult::Container do
    ...
    describe "#is_result?" do
      let(:user_class) do
        Class.new do
          ...
          import :"commands.is_result?", from: ConvenientService::Service::Plugins::HasResult::Container
        end
      end
      ...
      specify do
        expect { user_instance.commands.is_result?(result) }
          .to delegate_to(ConvenientService::Service::Plugins::HasResult::Commands::IsResult, :call)
