    ...
    describe ".call" do
      ...
      context "when `other` is symbol" do
        ...
        it "returns symbol casted to method name" do
          expect(casted).to eq(ConvenientService::Service::Plugins::HasResultSteps::Entities::Method::Entities::Name.new(other))
        end
      end
        ...
        context "when that hash has one key" do
          ...
          context "when value by that key is symbol" do
            ...
            it "returns proc casted to method name" do
              expect(casted).to eq(ConvenientService::Service::Plugins::HasResultSteps::Entities::Method::Entities::Name.new(:bar))
            end
          end
