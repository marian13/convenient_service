...
RSpec.describe ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Entities::ServiceAwareEnumerables::LazyEnumerator, type: :standard do
  include ConvenientService::RSpec::Matchers::DelegateTo

  let(:service_aware_lazy_enumerator) { described_class.new(object: object, organizer: organizer, propagated_result: propagated_result) }
  ...
  example_group "instance methods" do
    example_group "alias methods" do
      ...
      subject { service_aware_lazy_enumerator }
