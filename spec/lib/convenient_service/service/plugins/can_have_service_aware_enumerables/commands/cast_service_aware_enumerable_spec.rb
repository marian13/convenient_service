...
RSpec.describe ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Commands::CastServiceAwareEnumerable, type: :standard do
  ...
  example_group "class methods" do
    describe ".call" do
      ...
      let(:service_aware_enumerable) { ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Entities::ServiceAwareEnumerables::Enumerable.new(**arguments) }
      ...
      context "when `object` is NOT enumerable" do
        ...
        it "raises `ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Exceptions::ObjectIsNotEnumerable`" do
          expect { command_result }
            .to raise_error(ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Exceptions::ObjectIsNotEnumerable)
            .with_message(exception_message)
        end

        specify do
          expect { ignoring_exception(ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Exceptions::ObjectIsNotEnumerable) { command_result } }
      ...
      context "when `object` is enumerable" do
        context "when `object` is array" do
          let(:object) { [:foo, :bar] }
          let(:service_aware_enumerable) { ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Entities::ServiceAwareEnumerables::Array.new(**arguments) }

          it "returns step aware enumerable" do
            expect(command_result).to eq(service_aware_enumerable)
          end
        end

        context "when `object` is hash" do
          let(:object) { {foo: :bar, baz: :qux} }
          let(:service_aware_enumerable) { ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Entities::ServiceAwareEnumerables::Hash.new(**arguments) }
        ...
        context "when `object` is set" do
          ...
          let(:service_aware_enumerable) { ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Entities::ServiceAwareEnumerables::Set.new(**arguments) }
        ...
        context "when `object` is implicit enumerator" do
          ...
          let(:service_aware_enumerable) { ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Entities::ServiceAwareEnumerables::Enumerator.new(**arguments) }
        ...
        context "when `object` is implicit lazy enumerator" do
          ...
          let(:service_aware_enumerable) { ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Entities::ServiceAwareEnumerables::LazyEnumerator.new(**arguments) }
        ...
        context "when `object` is implicit chain enumerator" do
          ...
          let(:service_aware_enumerable) { ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Entities::ServiceAwareEnumerables::ChainEnumerator.new(**arguments) }
        ...
        context "when `object` is implicit arithmetic sequence" do
          ...
          let(:service_aware_enumerable) { ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Entities::ServiceAwareEnumerables::ArithmeticSequenceEnumerator.new(**arguments) }
