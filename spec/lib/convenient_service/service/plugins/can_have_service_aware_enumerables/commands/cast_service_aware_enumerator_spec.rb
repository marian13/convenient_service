...
RSpec.describe ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Commands::CastServiceAwareEnumerator, type: :standard do
      ...
      context "when `object` is NOT enumerable" do
        ...
        let(:exception_message) do
          <<~TEXT
            ...
            Maybe you mistyped `service_aware_enumerator` instead of `service_aware_enumerable`?
          TEXT
        end

        it "raises `ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Exceptions::ObjectIsNotEnumerator`" do
          expect { command_result }
            .to raise_error(ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Exceptions::ObjectIsNotEnumerator)
            .with_message(exception_message)
        end

        specify do
          expect { ignoring_exception(ConvenientService::Service::Plugins::CanHaveServiceAwareEnumerables::Exceptions::ObjectIsNotEnumerator) { command_result } }
