...
RSpec.describe ConvenientService::Service::Plugins::DisplaysResult::Success::Middleware do
  ...
  example_group "instance methods" do
    describe "#call" do
      ...
      let(:kwargs) { {data: {foo: "Success data"}} }
      ...
      context "when entity has display instance variable" do
        context "when its value is true" do
          it "prints result" do
            expect { method_value }.to output("\e[32;1m#{kwargs[:data]}\e[0m\n").to_stdout
          end
        ...
        context "when its value is false" do
          ...
          it "does NOT print result" do
            expect { method_value }.not_to output("\e[32;1m#{kwargs[:data]}\e[0m\n").to_stdout
          end
