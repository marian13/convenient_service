...
RSpec.describe ConvenientService::Service::Plugins::CanHaveConnectedSteps::Entities::Expressions::Else, type: :standard do
  ...
  example_group "instance methods" do
    ...
    describe "#inspect" do
      it "returns inspect representation" do
        expect(expression.inspect).to eq("else #{sub_expression.inspect} end")
      end
    end

    describe "#else?" do
      it "returns `true`" do
        expect(expression.else?).to eq(true)
      end
    end
