...
RSpec.describe ConvenientService::Service::Plugins::CanHaveConnectedSteps::Exceptions, type: :standard do
  ...
  specify { expect(described_class::FirstConditionalGroupStepIsNotSet).to be_descendant_of(ConvenientService::Exception) }
  specify { expect(described_class::ElseWithoutIf).to be_descendant_of(ConvenientService::Exception) }
  specify { expect(described_class::ElseIfAfterElse).to be_descendant_of(ConvenientService::Exception) }
  specify { expect(described_class::EmptyExpressionHasNoResult).to be_descendant_of(ConvenientService::Exception) }
  specify { expect(described_class::EmptyExpressionHasNoOrganizer).to be_descendant_of(ConvenientService::Exception) }
