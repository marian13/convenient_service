  ...
  example_group "class methods" do
    describe ".message_class?" do
      ...
      context "when `message` is NOT class" do
        ...
        it "returns `false`" do
          expect(klass.message_class?(message_class)).to eq(false)
        end
      end
      ...
      context "when `message` is class" do
        context "when `message` is NOT message class" do
          ...
          context "when `message` is entity class" do
            ...
            it "returns `false`" do
              expect(klass.message_class?(service_class)).to eq(false)
            end
          end
        end
        ...
        context "when `message` is message class" do
          ...
          it "returns `true`" do
            expect(klass.message_class?(message_class)).to eq(true)
          end
        end
      end
    end
