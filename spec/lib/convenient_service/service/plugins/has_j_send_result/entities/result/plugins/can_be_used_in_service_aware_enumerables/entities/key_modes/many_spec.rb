...
RSpec.describe ConvenientService::Service::Plugins::HasJSendResult::Entities::Result::Plugins::CanBeUsedInServiceAwareEnumerables::Entities::KeyModes::Many, type: :standard do
  ...
  example_group "instance methods" do
    ...
    describe "#many?" do
      it "returns `true`" do
        expect(key_mode.many?).to be(true)
      end
    end
  end
end
