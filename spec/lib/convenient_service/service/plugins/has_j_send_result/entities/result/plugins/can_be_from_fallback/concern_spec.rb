  ...
  example_group "instance methods" do
    ...
    describe "#from_fallback_failure_result?" do
      context "when result is from `result` method" do
        ...
        it "returns `false`" do
          expect(result.from_fallback_failure_result?).to be(false)
        end
      end
      ...
      context "when result is from `fallback_failure_result` method" do
        ...
        it "returns `true`" do
          expect(result.from_fallback_failure_result?).to be(true)
        end
      end
    ...
    describe "#from_fallback_error_result?" do
      context "when result is from `result` method" do
        ...
        it "returns `false`" do
          expect(result.from_fallback_error_result?).to be(false)
        end
      end
      ...
      context "when result is from `fallback_error_result` method" do
        ...
        it "returns `true`" do
          expect(result.from_fallback_error_result?).to be(true)
        end
      end
    ...
    describe "#from_fallback_result?" do
      context "when result is from `result` method" do
        ...
        it "returns `false`" do
          expect(result.from_fallback_result?).to be(false)
        end
      end
      ...
      context "when result is from `fallback_result` method" do
        ...
        it "returns `true`" do
          expect(result.from_fallback_result?).to be(true)
        end
      end
    end
    ...
    describe "#from_fallback?" do
      context "when result is from `result` method" do
        ...
        it "returns `false`" do
          expect(result.from_fallback?).to be(false)
        end
      end
      ...
      context "when result is from `fallback_failure_result` method" do
        ...
        it "returns `true`" do
          expect(result.from_fallback?).to be(true)
        end
      end
