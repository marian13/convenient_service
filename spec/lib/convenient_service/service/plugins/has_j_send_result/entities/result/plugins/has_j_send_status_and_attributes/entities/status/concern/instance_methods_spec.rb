...
RSpec.describe ConvenientService::Service::Plugins::HasJSendResult::Entities::Result::Plugins::HasJSendStatusAndAttributes::Entities::Status::Concern::InstanceMethods, type: :standard do
  ...
  example_group "class methods" do
    describe ".new" do
      context "when `result` is NOT passed" do
        let(:status) { ConvenientService::Service::Plugins::HasJSendResult::Entities::Result::Plugins::HasJSendStatusAndAttributes::Entities::Status.new(value: :foo) }
  ...
  example_group "instance methods" do
    ...
    describe "#unsafe_success?" do
      context "when `value` is NOT `:success`" do
        it "returns `false`" do
          expect(status.unsafe_success?).to be(false)
        end
      end
      ...
      context "when `value` is `:success`" do
        ...
        it "returns `true`" do
          expect(status.unsafe_success?).to be(true)
        end
      end
    end

    describe "#unsafe_failure?" do
      context "when `value` is NOT `:failure`" do
        it "returns `false`" do
          expect(status.unsafe_failure?).to be(false)
        end
      end
      ...
      context "when `value` is `:failure`" do
        ...
        it "returns `true`" do
          expect(status.unsafe_failure?).to be(true)
        end
      end
    end

    describe "#unsafe_error?" do
      context "when `value` is NOT `:error`" do
        it "returns `false`" do
          expect(status.unsafe_error?).to be(false)
        end
      end
      ...
      context "when `value` is `:error`" do
        ...
        it "returns `true`" do
          expect(status.unsafe_error?).to be(true)
        end
      end
    end
    ...
    describe "#unsafe_not_success?" do
      context "when `value` is NOT `:success`" do
        it "returns `true`" do
          expect(status.unsafe_not_success?).to be(true)
        end
      end
      ...
      context "when `value` is `:success`" do
        ...
        it "returns `false`" do
          expect(status.unsafe_not_success?).to be(false)
        end
      end
    end
    ...
    describe "#unsafe_not_failure?" do
      context "when `value` is NOT `:failure`" do
        it "returns `true`" do
          expect(status.unsafe_not_failure?).to be(true)
        end
      end
      ...
      context "when `value` is `:failure`" do
        ...
        it "returns `false`" do
          expect(status.unsafe_not_failure?).to be(false)
        end
      end
    end
    ...
    describe "#unsafe_not_error?" do
      context "when `value` is NOT `:error`" do
        it "returns `true`" do
          expect(status.unsafe_not_error?).to be(true)
        end
      end
      ...
      context "when `value` is `:error`" do
        ...
        it "returns `false`" do
          expect(status.unsafe_not_error?).to be(false)
        end
      end
    end
    ...
    describe "#in?" do
      context "when `statuses` are NOT empty" do
        context "when `status` is NOT equal to any of those statuses" do
          let(:statuses) do
            [
              ConvenientService::Service::Plugins::HasJSendResult::Entities::Result::Plugins::HasJSendStatusAndAttributes::Entities::Status.new(value: :bar, result: result),
              ConvenientService::Service::Plugins::HasJSendResult::Entities::Result::Plugins::HasJSendStatusAndAttributes::Entities::Status.new(value: :baz, result: result)
            ]
          end

          it "returns `false`" do
            expect(status.in?(statuses)).to be(false)
          end
        end
        ...
        context "when `status` is equal to any of those statuses" do
          let(:statuses) do
            [
              ConvenientService::Service::Plugins::HasJSendResult::Entities::Result::Plugins::HasJSendStatusAndAttributes::Entities::Status.new(value: :bar, result: result),
              ConvenientService::Service::Plugins::HasJSendResult::Entities::Result::Plugins::HasJSendStatusAndAttributes::Entities::Status.new(value: :foo, result: result)
            ]
          end

          it "returns `true`" do
            expect(status.in?(statuses)).to be(true)
          end
        end
      end
    ...
    example_group "comparisons" do
      describe "#==" do
        ...
        context "when `other` has different `value`" do
          let(:other) { ConvenientService::Service::Plugins::HasJSendResult::Entities::Result::Plugins::HasJSendStatusAndAttributes::Entities::Status.new(value: :bar, result: result) }
        ...
        context "when `other` has different `result.class`" do
          let(:other) { ConvenientService::Service::Plugins::HasJSendResult::Entities::Result::Plugins::HasJSendStatusAndAttributes::Entities::Status.new(value: value, result: Object.new) }
        ...
        context "when `other` has same attributes" do
          let(:other) { ConvenientService::Service::Plugins::HasJSendResult::Entities::Result::Plugins::HasJSendStatusAndAttributes::Entities::Status.new(value: value, result: result) }
