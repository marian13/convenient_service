...
return unless defined? ConvenientService::Feature::Plugins::HasAmazingPrintInspect

# rubocop:disable RSpec/NestedGroups, RSpec/MultipleMemoizedHelpers
RSpec.describe ConvenientService::Feature::Plugins::HasAmazingPrintInspect::Concern, type: :amazing_print do
  ...
  example_group "instance methods" do
    let(:feature_class) do
      Class.new do
        include ConvenientService::Feature::Standard::Config.with(:amazing_print_inspect)
