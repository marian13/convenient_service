...
RSpec.describe ConvenientService::Examples::Standard::V1::RequestParams::Services::Prepare do
    ...
    describe ".result" do
      ...
      context "when request is NOT valid to extract params from path" do
        ...
        it "fails to extract params from path" do
          expect(result).to be_error.of_step(ConvenientService::Examples::Standard::V1::RequestParams::Services::ExtractParamsFromPath)
        end
      end
      ...
      context "when request is NOT valid to extract params from body" do
        ...
        it "fails to extract params from body" do
          expect(result).to be_error.of_step(ConvenientService::Examples::Standard::V1::RequestParams::Services::ExtractParamsFromBody)
        end
      end
      ...
      context "when request is valid to extract params from both path and body" do
        it "merges params extracted from path and body" do
          ...
          #
          ConvenientService::Examples::Standard::V1::RequestParams::Services::MergeParams.commit_config!
        ...
        it "logs merged params from path and body with \"Uncasted\" tag" do
          ...
          # TODO: Introduce `delegate_to_service` to hide `commit_config!`.
          #
          ConvenientService::Examples::Standard::V1::RequestParams::Services::LogRequestParams.commit_config!
        ...
        it "filters out unpermitted keys" do
          ConvenientService::Examples::Standard::V1::RequestParams::Services::FilterOutUnpermittedParams.commit_config!
        ...
        it "applies default values" do
          ConvenientService::Examples::Standard::V1::RequestParams::Services::ApplyDefaultParamValues.commit_config!
      ...
      context "when uncasted params are NOT valid" do
        ...
        it "fails to validate uncasted params" do
          expect(result).to be_error.of_step(ConvenientService::Examples::Standard::V1::RequestParams::Services::ValidateUncastedParams)
        end
      end
      ...
      context "when casted params are NOT valid" do
        ...
        it "fails to validate casted params" do
          expect(result).to be_error.of_step(ConvenientService::Examples::Standard::V1::RequestParams::Services::ValidateCastedParams)
        end
      end
