...
RSpec.describe ConvenientService::Examples::Standard::V1::Gemfile::Services::FormatBody, type: :standard do
  ...
  example_group "class methods" do
    describe ".result" do
      ...
      context "when `FormatBody` is successful" do
        ...
        specify do
          expect { result }
            .to delegate_to(ConvenientService::Examples::Standard::V1::Gemfile::Services::FormatGemsWithoutEnvs, :result)
            .with_arguments(parsed_content: parsed_content)
        end

        specify do
          expect { result }
            .to delegate_to(ConvenientService::Examples::Standard::V1::Gemfile::Services::FormatGemsWithEnvs, :result)
            .with_arguments(parsed_content: parsed_content)
        end
