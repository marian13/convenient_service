...
RSpec.describe ConvenientService::Examples::Standard::V1::Gemfile::Services::ParseContent, type: :standard do
    ...
    describe ".result" do
      ...
      context "when `ParseContent` is NOT successful" do
        ...
        context "when `AssertValidRubySyntax` is NOT successful" do
          before do
            stub_service(ConvenientService::Examples::Standard::V1::Gemfile::Services::AssertValidRubySyntax)
              .with_arguments(content: content)
              .to return_error
          end

          it "returns intermediate step result" do
            expect(result).to be_not_success.of_step(ConvenientService::Examples::Standard::V1::Gemfile::Services::AssertValidRubySyntax)
          end
        end
      end
