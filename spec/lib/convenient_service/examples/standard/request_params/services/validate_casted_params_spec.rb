...
RSpec.describe ConvenientService::Examples::Standard::RequestParams::Services::ValidateCastedParams, type: :standard do
  ...
  example_group "class methods" do
    describe ".result" do
      ...
      let(:casted_id) { ConvenientService::Examples::Standard::RequestParams::Entities::ID.cast(original_params[:id]) }
      let(:casted_format) { ConvenientService::Examples::Standard::RequestParams::Entities::Format.cast(original_params[:format]) }
      let(:casted_title) { ConvenientService::Examples::Standard::RequestParams::Entities::Title.cast(original_params[:title]) }
      let(:casted_description) { ConvenientService::Examples::Standard::RequestParams::Entities::Description.cast(original_params[:description]) }
