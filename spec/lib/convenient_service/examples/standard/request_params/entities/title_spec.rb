...
RSpec.describe ConvenientService::Examples::Standard::RequestParams::Entities::Title, type: :standard do
  ...
  example_group "instance methods" do
    ...
    describe "#==" do
      ...
      context "when `other` has different values" do
        ...
        it "returns true" do
          expect(title == other).to be(false)
        end
      end
